...
router.patch('/update-my-profile', (0, auth_1.default)(client_1.userRole.ADMIN, client_1.userRole.SUPPER_ADMIN, client_1.userRole.USER), fileUploader_1.fileUploader.upload.single('file'), (req, res, next) => {
